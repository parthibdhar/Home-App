...
const SearchBar = () => {
  return (
    <div className="col-span-2 ml-2">
          <form action="" className="w-full h-full rounded ">
            <div class="relative">
              ...
              <input
                type="text"
                class="bg-white border-2 border-gray-300 text-gray-600 text-lg rounded-full focus:border-gray-400 h-full w-fit pl-16 px-72 py-4 "
                placeholder="Search"
              />
            </div>
          </form>
